...
export function ProfilePreview() {
  const [profile, setProfile] = useState<ProfilePairingMetadata | null>(null)
  ...
  return (
    <div className="space-y-4">
      ...
      <Button variant="link" className="p-0 h-auto w-full justify-start text-primary" onClick={openProfileEditor}>
