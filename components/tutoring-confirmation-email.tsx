  ...
  return (
    <div className="max-w-2xl mx-auto bg-white font-sans">
      ...
      <div className="bg-gray-100 p-4 rounded-t-lg border-b">
        ...
        <p className="font-semibold text-gray-900">{studentName}'s Tutoring Sessions [PLEASE REPLY]</p>
      </div>
      ...
      <div className="p-6">
        ...
        <p className="mb-4 text-gray-900 leading-relaxed">
          Thanks for signing up {studentName} to Connect Me Online Tutoring! We've reviewed the application, and have
          matched {possessivePronoun} with a tutor for the subjects requested: <strong>{subjects.join(", ")}</strong>,
        ...
        <p className="mb-4 text-gray-900 leading-relaxed">
          ...
          . We have included the Zoom link below, which will be reusable each week.
        </p>

        {/* Highlighted Section */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 my-6">
          <p className="text-blue-800 font-semibold text-center">
            {studentName}'s first session will be on {firstSessionDate} from {sessionTime}.
          </p>
        </div>
        ...
        <p className="mb-4 text-gray-900 leading-relaxed">
          <strong>Please reply and confirm with us whether these dates/times work.</strong> The tutor should contact you
          a couple of days before the session, and I have included their contact information below.
        </p>

        <p className="mb-6 text-gray-900 leading-relaxed">
          We're looking forward to tutoring {studentName} the Connect Me way!
        </p>
