"use client";
import React, { useState, useEffect, useCallback, use, Suspense, lazy } from "react";
...
const ActiveSessionsTable = lazy(() => import("./components/ActiveSessionsTable"))
const CurrentSessionsTable = lazy(() => import("./components/CurrentSessionsTable") )
const CompletedSessionsTable = lazy(() => import("./components/CompletedSessionsTable"))
